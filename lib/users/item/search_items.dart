  ...
  Future<List<Books>> readSearchRecordsFound() async
  {
    ...
    if(searchController.text != "")
    {
      try
      {
        ...
        final uri = Uri.parse("https://localhost:7075/gateway/searchbookbyname").replace(queryParameters: {
          "nameBook": searchController.text,
        });
        ...
        {
          var responseBodyOfSearch = jsonDecode(res.body);
          // print(responseBodyOfTrending);
          (responseBodyOfSearch as List).forEach((eachRecord)
          {
            booksSearchList.add(Books.fromJson(eachRecord));
          });
        }
        else
        {
